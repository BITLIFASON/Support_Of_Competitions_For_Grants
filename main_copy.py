...
def print_row():
    #print(konk_view_form.tableView.selectionModel().selectedRows())
    rows = sorted(set(index.row() for index in konk_view_form.tableView.selectionModel().selectedRows()))
    for row in rows:
...
window_list = [main_window, konk_view_window, vuz_view_window, proj_view_window,  help_view_window, help_prog_view_window]
